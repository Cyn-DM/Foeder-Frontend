...
export default function AddRecipe(){
    ...
    const handleStepCountIncrease = () => setStepCount((prev) => prev + 1);
                    ...
                    <div className="w-fit">
                        ...
                        <div className="flex flex-col w-full bg-white rounded-lg mb-8 p-8">
                            <div className="flex flex-col w-full mb-4">
                                <IngredientList handleIngredientDecrease={handleIngredientCountDecrease}
                                                ingredientCount={ingredientCount}/>
                            </div>
                            <div className="inter-mainFont text-3xl mb-4">
                                <button className="flex " type="button" onClick={handleIngredientCountIncrease}>
                        ...
                        <div className="flex flex-col w-full bg-white rounded-lg p-8 mb-8">
                            <div className="flex flex-col w-full mb-4">
                                <StepList stepCount={stepCount} handleCountDecrease={handleStepCountDecrease}
                                          handleCountIncrease={handleStepCountIncrease}/>
                            </div>
                            <div className="inter-mainFont text-3xl mb-4">
                                <button className="flex " type="button" onClick={handleStepCountIncrease}>
                                    <div className="flex items-center gap-3">
...
function StepList({stepCount, handleCountDecrease}) {
    return (
        <>
            {Array.from({length: stepCount}).map((_, index) => {
                ...
                return (
                    ...
                    <div className="flex items-center gap-4 mb-4" key={keyword}>
...
function IngredientList({ingredientCount, handleIngredientDecrease}){
    return (
        <>
            {Array.from({length: ingredientCount}).map((_, index) => {
                ...
                return (
                    ...
                    <div className="flex items-center gap-4 mb-4" key={ingredientNr}>
                        ...
                        <input id="ingredientAmount"
                               ...
                               className="input input-bordered w-full max-w-sm"
                               placeholder="Amount"/>
                        <button type="button" onClick={handleIngredientDecrease}>
                            <svg width="53px" height="53px" viewBox="2 2 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
